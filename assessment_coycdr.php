...
for($i=1;$i<10; $i++)
{
     if ($i==1)
        ...
        $sql="INSERT into assessment21 values('$agniveer_no','$field','$weightage','$max','$BPET', '$BPETR')";
        ...
        $sql="INSERT into assessment21 values('$agniveer_no','$fields','$weightage','$max','$marks','$bpetr')";
        if (mysqli_query($conn, $sql)) 
        {
                          //echo "data inserted";
        }
